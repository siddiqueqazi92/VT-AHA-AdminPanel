// export const API_URL = "http://localhost:1337/api/v1/admin";// local

export const API_URL = "https://staging.allhailart.com/api/v1/admin"; //docker staging
// export const API_URL = "https://prod.allhailart.com/api/v1/admin"; //docker production

// export const API_URL = "https://dev.allhailart.com/api/v1/admin";// dev
